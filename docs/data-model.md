...
| `exercises`             | `lesson_id (unique), runner, language, starter_files jsonb, test_files jsonb, instructions, version, content_hash`                                                                                                                                              | runner: `sandpack` only (the in-house browser JS/TS runner; founder decision, end of S4).                                                                                          |

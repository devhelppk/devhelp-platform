      ...
      <main className="mx-auto w-full max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          ...
          >
            <p>
              ...
              more in it. <code>pnpm content:check</code> runs the same
              validation our CI does — schema, links, quiz answers, and your
              exercise&apos;s tests against your own solution — so you can see
              it pass before you open anything.
            </p>
            <p>
              The most useful contribution is not a new course. It is a
              scenario: a realistic way a working system breaks, with the
              repository that breaks that way.
            </p>
          </Door>
          ...
          >
            <p>
              ...
              , then <code>pnpm dev</code>. Two apps come up, with real seeded
              content.
            </p>
            <p>
              Every decision of consequence is written down in{" "}
              <code>docs/</code> with the reasoning and what was abandoned, so
              you can find out why something is the way it is before you change
              it.
            </p>
          </Door>
        </div>
        ...
        <section className="mt-12 flex flex-col gap-4 rounded-lg border p-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild>
              <a href={`${LMS}/mentor/apply`}>Apply to mentor</a>
            </Button>
          </div>
        </section>
        ...
        <section className="mt-12 flex flex-col gap-4">
          ...
          <p className="max-w-prose text-muted-foreground">
            ...
            fixing a typo in a title should not need a pull request, a review
            and a deploy, while changing what a lesson teaches should need all
            three.
          </p>
        </section>
        ...
        <section className="mt-12 flex flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            <Button variant="outline" asChild>
              <a href={`${LMS}/companies`}>Find a company</a>
            </Button>
          </div>
        </section>
        ...
        <section className="mt-12 flex flex-col gap-4">
          ...
          <ul className="flex max-w-prose list-disc flex-col gap-2 pl-5 text-muted-foreground">
            <li>
              A pull request needs one review. Be blunt about code and kind
              about people.
            </li>
            <li>
              Explain <em>why</em> in the commit message and in the code. A
              comment that says what the next person would have got wrong is
              worth more than one that repeats the line below it.
            </li>
            <li>
              <code>

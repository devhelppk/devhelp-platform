    ...
    <>
      ...
      <main className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <Section title="Who it is for">
          <p>
            The final-year student with a degree and no production experience.
            The fresh graduate whose interviews keep ending at the take-home.
            The engineer two years in who is good at shipping features and was
            never taught how to debug something they did not write, how to argue
            for a trade-off in writing, or what they should be paid.
          </p>
          <p>
        ...
        <Section title="What we think teaching should look like">
          <ul className="flex list-disc flex-col gap-3 pl-5">
            ...
            <li>
              <strong>A stated position on AI.</strong> Every lesson says
              whether you should use it. Pretending it does not exist teaches
              nothing; letting it write everything teaches less.
            </li>
            <li>
            ...
            <li>
              <strong>Communication counts as engineering.</strong> Offshore
              hires usually fail on writing and clarity, not on code, so that is
              a track and not an afterthought.
            </li>
          </ul>
        </Section>
        ...
        <Section title="The company bank">
          <p>
            ...
            the information to decide with barely exists. So the platform has a
            second half: reviews, interview experiences and real pay for
        ...
        <Section title="How it is built">
          <p>
            In public, in two repositories, by whoever shows up. The curriculum
            is CC BY-SA 4.0 and the platform is MIT. Every architectural
            decision is written down in the repository with the reasoning and
            the things that were tried and abandoned — including the ones that
            were wrong.
          </p>
          <p>
            The whole platform runs on a laptop with Docker and no paid keys,
            which is a deliberate constraint: a university department or a
            student society should be able to run their own copy without a
            budget or a conversation with us.
          </p>
        </Section>
        ...
        <Section title="What it will never do">
          <p>
            ...
            or contributors. Put a course behind a certificate paywall. Email
            you anything you did not ask for — the platform sends transactional
            mail only, and badges are announced in the app.
          </p>
        </Section>
        ...
        <Section title="Who is behind it">
          <p>
            ...
            engineers in Pakistan, with mentors contributing lessons and
            reviews. If you want to be one of them, that door is{" "}

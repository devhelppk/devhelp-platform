...
export default async function DashboardPage() {
  ...
  // Signed out → UNAUTHORIZED → sign in. Anything else is a real error and must surface.
  ...
  // The landing lives at `/` now, so a signed-out visitor to the dashboard is
  // sent to sign in and brought back here.
  if (enrollments === null) redirect("/sign-in?callbackURL=/home" as Route);

...
describe("safeCallback", () => {
  it("only allows same-origin paths", () => {
    ...
    expect(safeCallback("//evil.com")).toBe("/home");
    expect(safeCallback("https://evil.com")).toBe("/home");
    expect(safeCallback("/\\evil")).toBe("/home");
    expect(safeCallback(null)).toBe("/home");
  });
});
